...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfigurer(@Qualifier("appUserDetailsService") UserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("private/user", "/login")
